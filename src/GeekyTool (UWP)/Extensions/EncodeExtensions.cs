...
namespace GeekyTool.Extensions
{
    ...
    {
        public static async Task<string> ToBase64(this Image control)
        {
        ...
        public static async Task<string> ToBase64(this WriteableBitmap bitmap)
        {
        ...
        public static async Task<string> ToBase64(this RenderTargetBitmap bitmap)
        {
        ...
        public static async Task<string> ToBase64(this BitmapImage bitmap)
        {
        ...
        public static async Task<ImageSource> FromBase64(this string base64)
        {
            // read stream
        ...
        public static async Task<byte[]> GetStreamToBytesAsync(this IRandomAccessStream fileStream)
        {
        ...
        public static async Task<byte[]> ImageToByteArrayAsync(this StorageFile file)
        {
        ...
        public static async Task<BitmapImage> ConvertByteArrayToBitmapImage(this byte[] byteValue)
        {
